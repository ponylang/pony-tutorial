...
In fact all elements of Pony code are required to be ASCII, except String literals.
String literals happily accept any kind of bytes directly from the source file, be it UTF-8 encoded or ISO-8859-2 
and represent them in their encoded form.
