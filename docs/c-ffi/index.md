...
Native code can reach your program two ways: you can link a library, or you can write a small piece of C yourself and let ponyc compile it for you as a [C shim](/c-ffi/c-shims.md). You can also go the other direction — [export Pony methods](/c-ffi/exporting.md) so that C code can call them.
