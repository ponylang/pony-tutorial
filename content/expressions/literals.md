...
It is also possible to return an array with a different [Reference Capability](../capabilities/index.html) than `ref` just by specifying it on the type:
...
This way array literals can be used for creating arrays of any [Reference Capability](../capabilities/index.html).
